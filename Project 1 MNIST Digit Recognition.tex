...
\begin{document}
	...
	\begin{center}
		\Large \textbf{MNIST digit recognition using DNN, CNN and SVM}\\[0.2cm]
		\normalsize
		Practical Application of Machine Learning Algorithm \\
		Author: Debojit Roy Chowdhury \\[0.1cm]
		Tools Used: Python \\[0.1cm]
		Dataset Source: Machine Learning Mastery \\
	...
	\begin{itemize}
		\item Y. LeCun, C. Cortes, and C. J. C. Burges, “The MNIST Database of Handwritten Digits,” 1998.\\
		\url{http://yann.lecun.com/exdb/mnist/}
		
		\item J. Brownlee, “How to Develop a Convolutional Neural Network for MNIST Handwritten Digit Classification,” Machine Learning Mastery, 2019.\\
		\url{https://machinelearningmastery.com/how-to-develop-a-convolutional-neural-network-from-scratch-for-mnist-handwritten-digit-classification/}
	\end{itemize}
